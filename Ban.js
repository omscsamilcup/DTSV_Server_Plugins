...
const config = {
    ...
    disableBlackBE: true,
    kickByCloudMsg: "§7You are disconnected from the server\n\n§cYou are temprarily banned until §l§f%ENDTIME% from DTSV Server!\n\n§7Reason: §f%REASON%\n§l§7Appeal Here: https://discord.gg/dBUVcJVrWr",
    kickByLocalMsg: "§7You are disconnected from the server\n\nl§cYou are temprarily banned until §l§f%ENDTIME% from DTSV Server!\n\n§7Reason: §f%REASON%\n§l§7Appeal Here: https://discord.gg/dBUVcJVrWr",
    serverName: '',
