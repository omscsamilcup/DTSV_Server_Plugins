...
ll.registerPlugin(
    /* name */ "File",
    /* introduction */ "DTSV Config File",
    /* version */ [0,0,1],
    /* otherInformation */ null
); 

var money = new KVDatabase('C:/DTSV_Server/DTSV_Lite_Server/plugins/AllConfig_Data/Money.json')
var rank = new KVDatabase('C:/DTSV_Server/DTSV_Lite_Server/plugins/AllConfig_Data/rank.json')
var data = new KVDatabase('C:/DTSV_Server/DTSV_Lite_Server/plugins/AllConfig_Data/data.json')
var rebirth = new KVDatabase('C:/DTSV_Server/DTSV_Lite_Server/plugins/AllConfig_Data/rebirth.json')
...
var mine_level = new KVDatabase('C:/DTSV_Server/DTSV_Lite_Server/plugins/AllConfig_Data/miner_level.json')